...
class PetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create petition" do
    assert_difference('Petition.count') do
      post petitions_url, params: { petition: { country: @petition.country, description: @petition.description, image: @petition.image, location: @petition.location, state: @petition.state, tag: @petition.tag, video_url: @petition.video_url } }
    end
  ...
  test "should update petition" do
    patch petition_url(@petition), params: { petition: { country: @petition.country, description: @petition.description, image: @petition.image, location: @petition.location, state: @petition.state, tag: @petition.tag, video_url: @petition.video_url } }
